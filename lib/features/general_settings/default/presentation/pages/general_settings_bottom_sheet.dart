...
class GeneralSettingsBottomSheet extends StatefulWidget {
  const GeneralSettingsBottomSheet({super.key});

  @override
  State<GeneralSettingsBottomSheet> createState() =>
      _GeneralSettingsBottomSheetState();
}

class _GeneralSettingsBottomSheetState
    extends State<GeneralSettingsBottomSheet> {
  @override
                ...
                children: [
                  ...
                  SettingsListItem(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                        CupertinoPageRoute(
                          builder: (context) => ManageSubscriptionBottomSheet(),
                        ),
                      );
                    },
                  ),
                  ...
                  SettingsListItem(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                        CupertinoPageRoute(
                          builder: (context) => VoteOnNextFeatureBottomSheet(),
                        ),
                      );
                    },
                  ),
