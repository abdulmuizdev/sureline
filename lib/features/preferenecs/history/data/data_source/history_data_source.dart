...
abstract class HistoryDataSource {
  Future<Either<Failure, List<HistoryModel>>> getHistory({required bool isPremium});
}
...
class HistoryDataSourceImpl implements HistoryDataSource {
  ...
  @override
  Future<Either<Failure, List<HistoryModel>>> getHistory({required bool isPremium}) async {
    final quotes = await quotesDao.getShownQuotes(isPremium: isPremium);
