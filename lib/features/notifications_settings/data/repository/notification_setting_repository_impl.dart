...
/// Implementation of the NotificationSettingRepository interface.
/// This class acts as the data layer implementation for notification preset management,
/// delegating actual data operations to the NotificationSettingsDataSource.
///
/// The repository implementation handles conversion between domain entities and data models,
/// ensuring proper separation between the domain and data layers while maintaining
/// the contract defined by the repository interface.
class NotificationSettingRepositoryImpl extends NotificationSettingRepository {
  ...
  Future<Either<Failure, void>> addNotificationPreset(NotificationPresetEntity entity) {
    return dataSource.addNotificationPreset(NotificationPresetModel.fromEntity(entity));
  }
  ...
  @override
  Future<Either<Failure, void>> editNotificationPreset(NotificationPresetEntity newEntity) {
    return dataSource.editNotificationPreset(NotificationPresetModel.fromEntity(newEntity));
  }

  @override
  Future<Either<Failure, void>> enableNotificationPreset(NotificationPresetEntity entity) {
    return dataSource.enableNotificationPreset(NotificationPresetModel.fromEntity(entity));
  }
