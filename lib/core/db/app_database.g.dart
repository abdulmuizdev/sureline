...
class $FavouritesTable extends Favourites
  ...
  @override
  List<GeneratedColumn> get $columns => [id, quote, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Favourite extends DataClass implements Insertable<Favourite> {
  ...
  Favourite copyWith({int? id, String? quote, String? createdAt}) => Favourite(
    id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, quote, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Favourite &&
